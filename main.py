...
from helpers import *
import test as test
import finiteStateGrammar as FSG
...
if __name__ == '__main__':
	...
	utteranceArray1 = ['bihgSdrahmS', 'hhaorsS', 'hhuwSihzSdhaetS', 'dhowzSaarSchehSkerzS', 'tuwSchehSkerzSyehsS', 'pleySchehSkerzS', 'bihgShhaornS', 'gehtSowSverSmaaSmiyS', 'shaeSdowS', 'aySlaykSihtS', 'waySyuwSrehdSshaeSdowSyerSsehlfS']
	...
	# memory, lexicon, lexiconFrequency = memory.shortTermMemory(50, utteranceArray1)
	# print(memory)
	# print(lexicon)
